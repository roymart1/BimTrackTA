...
namespace BimTrackTA.API
{
    ...
    public class ProjectTeamApi : ApiBase
    {
        ...
        {
            string connStr = API_VERSION + "/hubs/" + hubId + "/projects/" + projectId + "/teams";
        ...
        {
            string connStr = API_VERSION + "/hubs/" + hubId + "/projects/" + projectId + "/teams/" + teamId;
        ...
        {
            string connStr = API_VERSION + "/hubs/" + hubId + "/projects/" + projectId + "/teams/users?teamId=" + teamId;
